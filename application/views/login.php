...
<body>
    ...
    <div class="app">
        ...
        <div class="bg">
		Jika tidak bisa login dan kembali lagi ke halaman ini, berarti password Anda salah!
		</div>
        ...
        <form method="post" action="<?php echo base_url();?>index.php/auth/login">
            ...
            <header>
                ...
                <img src="<?php echo base_url();?>assets/img/uniform.png">
 
            </header>
 
            <div class="inputs">
 
                <input type="text" name="username" placeholder="Nomor Karyawan">
